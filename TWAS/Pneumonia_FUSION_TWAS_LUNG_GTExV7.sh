...
#Pneumonia - GTEx v7 Whole_Lung weights
...
--chr ${chr} \
--out ~/data/users/william/2022_FinnGen_R6_meta/Meta_analysis_output/TWAS/2022_Lung/2022_Pneumonia_GTEx_V7_Lung_chr${chr}_FUSION
done
