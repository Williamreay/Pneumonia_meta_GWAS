...
CigsperDay <- fread("../FINAL_IVW_meta_analysis/Common_var/COJO_conditional/CigarettesPerDay.txt.gz", header = T)
...
write.table(Pneumonia_mtCOJO, file="Common_var_results/mtCOJO/2022_mtCOJO_pneumonia_meta_Cigsperday_merged.txt", sep = "\t", row.names = F, quote = F)
...
write.table(SmkInit_mtCOJO, file="Common_var_results/mtCOJO/2022_mtCOJO_CigsPerDay_meta.txt", sep = "\t", row.names = F, quote = F)
