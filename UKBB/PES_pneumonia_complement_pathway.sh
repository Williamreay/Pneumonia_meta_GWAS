...
## PRSice2 - PES: Complement pathway
...
do
  ...
  --snp rsID \
  --base /home/control/data/users/william/23andMe_pneumonia/IVW_23andMe_FinnGen_FINAL/PES_PRS/PES_pathway_variants/COMP_PATHWAY_variant_input \
  --type bgen \
  ...
  --thread 11 \
  --out Complement_pathway/PES_complement_pathway_chr${chr} ;
done
