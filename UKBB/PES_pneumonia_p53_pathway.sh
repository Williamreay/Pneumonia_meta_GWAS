...
do
  ...
  --snp rsID \
  --base /home/control/data/users/william/23andMe_pneumonia/IVW_23andMe_FinnGen_FINAL/PES_PRS/PES_pathway_variants/P53_PATHWAY_variant_input \
  --type bgen \
  ...
  --thread 11 \
  --out p53_pathway/PES_p53_pathway_chr${chr} ;
done
