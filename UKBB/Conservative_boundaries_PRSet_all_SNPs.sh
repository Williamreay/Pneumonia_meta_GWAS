...
#PBS -l select=1:ncpus=16:mem=200G,walltime=150:00:00
...
/home/c3202333/PRSice_linux --A1 EA --A2 NEA \
  ...
  --set-perm 10000 --wind-3 1500 --wind-5 5000 \
  --out /home/c3202333/Pneumonia_PRS_PES/Tclin_all_MSigDB/Conservative_boundaries_PRSET_all_SNPs
